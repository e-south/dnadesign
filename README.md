...
Use the tool READMEs below for task-specific docs and CLI entrypoints. This
catalog lists package surfaces, not one uniform workflow kind: some packages
own workspaces, some are stateless service CLIs, some publish shared contracts,
and `studies` holds study-family adapters. Stateless services such as
`folding` consume producer-owned artifacts and do not create independent
workspaces.
...
| [**studies**](src/dnadesign/studies/README.md) | Study-family adapter layer for checked-in study records, compilers, and family-owned observation/preflight logic. | [![studies coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=studies)](https://codecov.io/gh/e-south/dnadesign?component=studies) |
...
| [**construct**](src/dnadesign/construct/README.md) | Workspace-capable sequence construction tool for templates, parts, and contract-backed composition bundles. | [![construct coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=construct)](https://codecov.io/gh/e-south/dnadesign?component=construct) |
| [**folding**](src/dnadesign/folding/README.md) | Stateless secondary-structure service CLI/API for producer-owned request, prediction, and ViennaRNA plot artifacts. | [![folding coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=folding)](https://codecov.io/gh/e-south/dnadesign?component=folding) |
...
| [**baserender**](src/dnadesign/baserender/README.md) | Stateless schema-driven rendering runtime for visual contracts emitted by producer packages. | [![baserender coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=baserender)](https://codecov.io/gh/e-south/dnadesign?component=baserender) |
