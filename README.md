...
| [**studies**](src/dnadesign/studies/README.md) | Hold study-family adapters that read checked-in study records and plug family-owned observation/preflight logic into Ops. | [![studies coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=studies)](https://codecov.io/gh/e-south/dnadesign?component=studies) |
...
| [**latentdna**](src/dnadesign/latentdna/README.md) | Materialize workspace-owned latent views, samples, projections, and plots. | [![latentdna coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=latentdna)](https://codecov.io/gh/e-south/dnadesign?component=latentdna) |
...
| [**contracts**](src/dnadesign/contracts/README.md) | Publish shared cross-tool artifact contracts without importing tool internals. | [![contracts coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=contracts)](https://codecov.io/gh/e-south/dnadesign?component=contracts) |
...
| [**testsupport**](src/dnadesign/testsupport/README.md) | Share repo-level test fixtures across tool boundaries without importing tool-owned test packages. | [![testsupport coverage](https://codecov.io/gh/e-south/dnadesign/graph/badge.svg?component=testsupport)](https://codecov.io/gh/e-south/dnadesign?component=testsupport) |
---
