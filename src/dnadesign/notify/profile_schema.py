...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/notify/profile_schema.py
...
from .events_source import normalize_tool_name
from .workflow_policy import normalize_policy_name, supported_workflow_policies
