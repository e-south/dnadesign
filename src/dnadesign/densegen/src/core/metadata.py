...
def build_metadata(
    *,
    ...
    meta = {
        ...
        "input_pwm_selection_shortlist_min": input_meta.get("input_pwm_selection_shortlist_min"),
        "input_pwm_selection_shortlist_factor": input_meta.get("input_pwm_selection_shortlist_factor"),
        "input_pwm_selection_shortlist_max": input_meta.get("input_pwm_selection_shortlist_max"),
