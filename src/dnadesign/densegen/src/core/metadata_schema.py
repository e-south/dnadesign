...
META_FIELDS: list[MetaField] = [
    ...
    MetaField(
        "input_pwm_selection_shortlist_min",
        (int,),
        "Stage-A PWM selection shortlist minimum.",
        allow_none=True,
    ),
    MetaField(
        "input_pwm_selection_shortlist_factor",
        (int,),
        "Stage-A PWM selection shortlist factor.",
        allow_none=True,
    ),
    MetaField(
        "input_pwm_selection_shortlist_max",
        (int,),
        "Stage-A PWM selection shortlist max.",
        allow_none=True,
    ),
