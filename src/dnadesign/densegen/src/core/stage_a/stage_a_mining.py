...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/densegen/src/core/stage_a/stage_a_mining.py
...
from ...adapters.sources.pwm_fimo import (
    FimoHit,
    aggregate_best_hits,
...
from ..artifacts.ids import hash_candidate_id
from ..stage_a_constants import FIMO_REPORT_THRESH
