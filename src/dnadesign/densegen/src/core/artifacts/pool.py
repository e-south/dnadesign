        ...
        eligible_score_hist.append(
            {
                ...
                "motif_width": summary.motif_width,
                "trim_window_length": summary.trim_window_length,
                "trim_window_strategy": summary.trim_window_strategy,
                "trim_window_start": summary.trim_window_start,
                "trim_window_score": summary.trim_window_score,
                "trimmed_width": summary.trimmed_width,
                "trim_window_applied": summary.trim_window_applied,
