...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/densegen/tests/stage_a/test_stage_a_diversity_metrics.py
...
from dnadesign.densegen.src.core.stage_a.stage_a_diversity import (
    _core_entropy,
    _core_hamming_knn,
    _core_hamming_nnd,
    _diversity_summary,
...
from dnadesign.densegen.src.core.stage_a.stage_a_selection import (
