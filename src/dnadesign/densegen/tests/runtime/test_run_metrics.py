...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/densegen/tests/runtime/test_run_metrics.py
        ...
        [
            {
                ...
                "densegen__used_tfbs_detail": [
                    {"part_kind": "tfbs", "regulator": "TF_A", "sequence": "AAAA", "offset": 0},
                    {"part_kind": "tfbs", "regulator": "TF_B", "sequence": "CCCCCC", "offset": 10},
                ],
                "length": 20,
            }
        ]
