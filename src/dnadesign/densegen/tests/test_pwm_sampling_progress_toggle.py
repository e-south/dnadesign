...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/densegen/tests/test_pwm_sampling_progress_toggle.py
...
from dnadesign.densegen.src.adapters.sources.stage_a_progress import _PwmSamplingProgress
