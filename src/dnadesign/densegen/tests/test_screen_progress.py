...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/densegen/tests/test_screen_progress.py
...
def test_screen_progress_allows_pixi_shell_when_tty(monkeypatch) -> None:
    ...
    assert settings.dashboard._live is None
