...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/densegen/tests/cli/test_cli_candidate_logging.py

Regression tests for CLI candidate logging DenseGen CLI.
...
def test_candidate_logging_enabled_toggle() -> None:
    cfg_path = Path("src/dnadesign/densegen/workspaces/demo_sampling_baseline/config.yaml")
