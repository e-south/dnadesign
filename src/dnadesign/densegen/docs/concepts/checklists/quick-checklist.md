...
DenseGen diagnostics and USR mutation events are distinct streams with distinct consumers. Read **[observability and events](../runtime/observability-and-events.md)** before wiring Notify.
