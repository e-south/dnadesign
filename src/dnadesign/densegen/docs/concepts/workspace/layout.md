...
- Read **[workspace templates](templates.md)** for packaged workspace taxonomy.
- Read **[pipeline lifecycle](../runtime/pipeline-lifecycle.md)** for stage and artifact flow.
- Read **[DenseGen quick checklist](../checklists/quick-checklist.md)** for a compact run command sequence.
