...
### Expected layout
This section defines the canonical workspace structure used by packaged templates and operator commands.
...
- Read **[operator arc](operator-arc.md)** for stage and artifact flow.
