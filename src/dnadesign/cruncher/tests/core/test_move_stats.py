...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/cruncher/tests/core/test_move_stats.py

Regression tests for move stats Cruncher core.
...
def test_move_stats_length_matches_sweeps() -> None:
    cfg = {
        "draws": 1,
        "tune": 1,
        "chains": 1,
    ...
    assert len(move_stats) == cfg["tune"] + cfg["draws"]
