## pairwise_soxr_soxs Runbook

**Workspace Path**
- src/dnadesign/cruncher/workspaces/pairwise_soxr_soxs/
...
### Step-by-Step Commands
    ...
    set -euo pipefail
    cd src/dnadesign/cruncher/workspaces/pairwise_soxr_soxs
    ...
    cruncher fetch sites --source regulondb --tf soxR --tf soxS --update -c "$CONFIG"
    ...
    cruncher discover motifs --set 1 --tool meme --meme-mod oops --source-id pairwise_soxr_soxs_merged_meme_oops -c "$CONFIG"
    ...
    cruncher catalog logos --source pairwise_soxr_soxs_merged_meme_oops --set 1 -c "$CONFIG"
