...
### Step-by-Step Commands
    ...
    # Trajectory video output is enabled in this demo config.
    # Best-of chain video is monotonic (timeline_mode: best_so_far) and writes plots/chain_trajectory_video.mp4.
