## pairwise_baer_lexa Runbook

**Workspace Path**
- src/dnadesign/cruncher/workspaces/pairwise_baer_lexa/
...
### Step-by-Step Commands
    ...
    set -euo pipefail
    cd src/dnadesign/cruncher/workspaces/pairwise_baer_lexa
    ...
    cruncher fetch sites --source regulondb --tf baeR --tf lexA --update -c "$CONFIG"
    ...
    cruncher discover motifs --set 1 --tool meme --meme-mod oops --source-id pairwise_baer_lexa_merged_meme_oops -c "$CONFIG"
    ...
    cruncher catalog logos --source pairwise_baer_lexa_merged_meme_oops --set 1 -c "$CONFIG"
