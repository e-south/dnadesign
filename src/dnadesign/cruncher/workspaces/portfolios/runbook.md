...
### Optional follow-up commands
    ...
    ls -1 outputs/master_all_workspaces/<portfolio_id>/tables/table__handoff_windows_long.*
    ls -1 outputs/master_all_workspaces/<portfolio_id>/tables/table__handoff_elites_summary.*
    ls -1 outputs/master_all_workspaces/<portfolio_id>/tables/table__handoff_sequence_length.*
