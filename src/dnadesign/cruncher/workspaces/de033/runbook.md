...
- Search the real built-in `neb_nicking_v1` plus `thermo_nicking_v1` nickase catalogs against the real built-in `type_iis_release_v1` release-enzyme catalog, pinned to `BspQI`, before materializing a bundle.
