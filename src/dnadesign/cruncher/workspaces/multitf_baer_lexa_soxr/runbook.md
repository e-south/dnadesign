## multitf_baer_lexa_soxr Runbook

**Workspace Path**
- src/dnadesign/cruncher/workspaces/multitf_baer_lexa_soxr/
...
### Step-by-Step Commands
    ...
    set -euo pipefail
    cd src/dnadesign/cruncher/workspaces/multitf_baer_lexa_soxr
    ...
    cruncher fetch sites --source regulondb --tf baeR --tf lexA --tf soxR --update -c "$CONFIG"
    ...
    cruncher discover motifs --set 1 --tool meme --meme-mod oops --source-id multitf_baer_lexa_soxr_merged_meme_oops -c "$CONFIG"
    ...
    cruncher catalog logos --source multitf_baer_lexa_soxr_merged_meme_oops --set 1 -c "$CONFIG"
