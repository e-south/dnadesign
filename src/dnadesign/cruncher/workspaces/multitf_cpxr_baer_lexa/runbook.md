## multitf_cpxr_baer_lexa Runbook

**Workspace Path**
- src/dnadesign/cruncher/workspaces/multitf_cpxr_baer_lexa/
...
### Step-by-Step Commands
    ...
    set -euo pipefail
    cd src/dnadesign/cruncher/workspaces/multitf_cpxr_baer_lexa
    ...
    cruncher fetch sites --source demo_local_meme --tf cpxR --tf lexA --update -c "$CONFIG"
    cruncher fetch sites --source regulondb --tf cpxR --tf baeR --tf lexA --update -c "$CONFIG"
    ...
    cruncher discover motifs --set 1 --tool meme --meme-mod oops --source-id multitf_cpxr_baer_lexa_merged_meme_oops -c "$CONFIG"
    ...
    cruncher catalog logos --source multitf_cpxr_baer_lexa_merged_meme_oops --set 1 -c "$CONFIG"
