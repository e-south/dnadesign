...
--------------------------------------------------------------------------------
<cruncher project>
src/dnadesign/cruncher/src/utils/moves.py
...
from dnadesign.cruncher.config.schema_v2 import MoveConfig
...
def resolve_move_config(moves_cfg) -> MoveConfig:
    ...
    overrides = moves_cfg.overrides.model_dump(exclude_none=True)
