...
def write_candidate_table(run_dir: Path, report: ScarNickEvaluationReport) -> None:
    fieldnames = [
        ...
        "nickase_canonical_motif_top_5to3",
        "nickase_strand",
            ...
            writer.writerow(
                {
                    ...
                    "non_wc_count": candidate.non_watson_crick_count,
                    ...
                    "nickase_canonical_motif_top_5to3": ("" if nickase is None else nickase.canonical_motif_top_5to3),
                ...
                writer.writerow(
                    {
                        ...
                        "aligned_pair_identity": f"{pair.left_base}:{pair.aligned_right_base}",
