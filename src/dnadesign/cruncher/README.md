...
- **YIU hairpin oligo workflows:** validate protocol-aware `.yiu.yaml` specs, materialize step traces across molecular states, and publish per-state contracts under a separate explicit bundle root.
...
6. [YIU workspace demo](docs/demos/demo_yiu_workspace.md): scaffold a YIU workspace and inspect the explicit protocol-state bundle.
...
9. [YIU workflow](docs/guides/yiu_workflow.md): validate and materialize a protocol-state YIU spec.
