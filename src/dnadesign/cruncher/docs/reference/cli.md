...
Scaffold an isolated cassette-specific workspace root with pressure-tested solve specs for different runtime budgets.
...
* `uv run cruncher cassette init-workspace --output ./cassette_lab`
...
* this is a cassette-only scaffold, not a full general Cruncher sampling workspace
