...
_ATTR_SOURCES: dict[str, tuple[str, str]] = {
    ...
    "main": (".src.cli", "main"),
    "app": (".src.cli", "app"),
    "pkg_usr_root": (".src.cli_support.roots", "pkg_usr_root"),
    "resolve_usr_root_from_config": (".src.cli_support.roots", "resolve_usr_root_from_config"),
    "resolve_usr_root_from_env": (".src.cli_support.roots", "resolve_usr_root_from_env"),
    ...
    "OVERLAY_DIGEST_LEDGER_FILENAME": (".src.overlay_support.digest_ledger", "OVERLAY_DIGEST_LEDGER_FILENAME"),
    "OVERLAY_DIGEST_LEDGER_SCHEMA_VERSION": (
        ".src.overlay_support.digest_ledger",
        "OVERLAY_DIGEST_LEDGER_SCHEMA_VERSION",
    ),
    "build_overlay_digest_ledger": (".src.overlay_support.digest_ledger", "build_overlay_digest_ledger"),
    "overlay_digest_ledger_path": (".src.overlay_support.digest_ledger", "overlay_digest_ledger_path"),
    "update_overlay_digest_ledger": (".src.overlay_support.digest_ledger", "update_overlay_digest_ledger"),
    "write_overlay_digest_ledger": (".src.overlay_support.digest_ledger", "write_overlay_digest_ledger"),
}
