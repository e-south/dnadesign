...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/test_dataset_write_session_module.py
...
def test_dataset_write_session_module_importable() -> None:
    assert importlib.import_module("dnadesign.usr.src.dataset_write_session")
...
def test_dataset_write_session_methods_delegate_to_session_module() -> None:
    ...
    assert "init_dataset(" in init_source
    assert "DatasetWriteSession(self)" in write_session_source
