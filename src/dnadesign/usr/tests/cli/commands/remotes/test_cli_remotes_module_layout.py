...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/cli/commands/remotes/test_cli_remotes_module_layout.py
...
def test_usr_cli_remotes_module_importable() -> None:
    module = importlib.import_module("dnadesign.usr.src.cli.commands.remotes")
    ...
    assert hasattr(module, "cmd_remotes_status")
    assert hasattr(module, "cmd_remotes_warm_auth")
...
def test_usr_cli_remotes_commands_delegate_to_remotes_module() -> None:
    ...
    assert "remotes_commands.cmd_remotes_status(" in source
    assert "remotes_commands.cmd_remotes_warm_auth(" in source
