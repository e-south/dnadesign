...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/cli/support/test_cli_merge_policy_registry_module.py
...
from dnadesign.usr.src.cli.support.resolution.merge_policy import register_merge_policy, resolve_merge_policy
from dnadesign.usr.src.contracts import SequencesError
from dnadesign.usr.src.datasets.merge import MergePolicy
