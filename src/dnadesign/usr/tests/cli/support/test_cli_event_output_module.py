...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/cli/support/test_cli_event_output_module.py
...
from dnadesign.usr.src.cli.support.presentation.event_output import emit_event_line, register_event_output_format
