...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/cli/support/test_cli_deps_module_layout.py
...
import dnadesign.usr.src.cli.support.wiring.dependencies as cli_dependency_support
...
def test_usr_cli_dependency_support_module_importable() -> None:
...
def test_usr_cli_dependency_builders_delegate_to_module() -> None:
    ...
    assert "dependency_support.build_read_view_deps(" in source
    assert "dependency_support.build_runtime_deps(" in source
    assert "dependency_support.build_materialize_deps(" in source
    assert "dependency_support.build_snapshot_deps(" in source
    assert "dependency_support.build_maintenance_deps(" in source
    assert "dependency_support.build_merge_deps(" in source
    assert "dependency_support.build_namespace_deps(" in source
    assert "dependency_support.build_tooling_deps(" in source


def test_usr_cli_dependency_support_wraps_command_level_builders() -> None:
    source = inspect.getsource(cli_dependency_support)
    ...
    assert "deps_commands.build_snapshot_deps(" in source
