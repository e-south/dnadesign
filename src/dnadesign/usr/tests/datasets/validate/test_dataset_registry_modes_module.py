...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/datasets/validate/test_dataset_registry_modes_module.py
...
from dnadesign.usr.src.datasets.validate.registry_modes import normalize_registry_mode, register_registry_mode
