...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/datasets/merge/test_merge_overlay_carry.py
...
from dnadesign.devtools.testsupport.usr import ensure_registry, register_test_namespace
