...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/datasets/overlay/test_dataset_overlay_maintenance_module.py
...
def test_dataset_overlay_maintenance_module_importable() -> None:
    assert importlib.import_module("dnadesign.usr.src.datasets.overlay.maintenance")
