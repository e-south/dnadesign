...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/usr/tests/datasets/lifecycle/test_dataset_materialize_module.py
...
def test_dataset_materialize_module_importable() -> None:
    assert importlib.import_module("dnadesign.usr.src.datasets.lifecycle.materialize")
