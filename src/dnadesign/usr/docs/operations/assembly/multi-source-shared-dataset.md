...
Once the merged upstream dataset has been realized into `"$DOWNSTREAM_DATASET"`, switch to the shared downstream continuation in [construct-infer-shared-dataset-runbook.md](../assembly/construct-infer-shared-dataset-runbook.md):
