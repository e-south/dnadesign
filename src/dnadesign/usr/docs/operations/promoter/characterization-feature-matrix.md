...
If you need a maintained answer to "where is this real study right now?", keep the companion [Stress ethanol/cipro status contract](../../../../../../docs/studies/stress_ethanol_cipro_growth/contracts/status.md) next to the active study manifest and affiliated-dataset registry.
