...
If you need a maintained answer to "where is this real study right now?", keep the companion [Stress ethanol/cipro status contract](../../../../../../docs/studies/stress_ethanol_cipro_growth/operations/catalog/status.md) next to the active study manifest and affiliated-dataset registry.
...
- [Multi-source shared dataset assembly](../assembly/multi-source-shared-dataset.md): use when the merged source dataset should be realized through construct into one downstream dataset.
- [Construct -> USR -> Infer shared dataset runbook](../assembly/construct-infer-shared-dataset-runbook.md): use when one construct-backed downstream dataset is already the intended canonical handoff.
...
- USR workflow map: [../routes/workflow-map.md](../routes/workflow-map.md)
- Multi-source upstream assembly: [../assembly/multi-source-shared-dataset.md](../assembly/multi-source-shared-dataset.md)
- Construct-backed shared dataset handoff: [construct-infer-shared-dataset-runbook.md](../assembly/construct-infer-shared-dataset-runbook.md)
