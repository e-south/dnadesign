...
2. Merge upstream sources when one shared dataset is required.
   Use [Multi-source shared dataset assembly](multi-source-shared-dataset-assembly.md) when DenseGen outputs, manual promoters, or wildtype controls still live in separate USR datasets.
