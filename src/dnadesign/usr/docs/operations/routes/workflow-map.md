...
Details: [hpc-agent-sync-flow.md](../sync/hpc-agent-flow.md#bootstrap-from-either-side)
...
Details: [hpc-agent-sync-flow.md](../sync/hpc-agent-flow.md#run-loop-hpc-side-writes-local-side-reads)
...
Details: [chained-densegen-infer-sync-runbook.md](../sync/chained-densegen-infer-runbook.md)
...
Details: [multi-source-shared-dataset-assembly.md](../assembly/multi-source-shared-dataset.md)
...
Details: [construct-infer-shared-dataset-runbook.md](../assembly/construct-infer-shared-dataset-runbook.md)
...
- Full command contract and option semantics: [sync.md](../sync/README.md)
