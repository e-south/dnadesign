...
- Flat ids:
  ...
  - `usr_promoter_references/` — USR-curated promoter reference anchors used by construct and promoter-study assembly flows; includes primer-flank-stripped MG1655 GenBank-projected inserts plus the incumbent J23105 pDual reference
