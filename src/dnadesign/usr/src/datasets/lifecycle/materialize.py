...
from ...contracts import REQUIRED_COLUMNS, Fingerprint, NamespaceError, SchemaError
    ...
    with dataset_write_lock(dataset.dir):
        ...
        try:
            ...
            for idx, path in enumerate(overlays):
                ...
                overlay_source = dataset._create_overlay_view(con, view_name=view_name, path=path, key=key)
