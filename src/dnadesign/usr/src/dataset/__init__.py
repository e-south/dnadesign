...
from ..contracts import REQUIRED_COLUMNS, AddSequencesResult, DatasetInfo, Manifest, OverlayInfo
from ..datasets import lifecycle as dataset_lifecycle
from ..datasets.core.activity import append_meta_note as append_dataset_meta_note
from ..datasets.core.activity import record_dataset_activity_event
from ..datasets.core.identity import normalize_dataset_id as normalize_dataset_id_impl
from ..datasets.core.identity import open_dataset
from ..datasets.core.ingest import (
...
from ..datasets.state.reserved_overlay import write_reserved_overlay
...
class Dataset:
    ...
    def stats(self):
        ...
        from ..sync.remote.diff import parquet_stats
    ...
    def snapshot(self) -> None:
        ...
        dataset_lifecycle.snapshot_dataset(self)
