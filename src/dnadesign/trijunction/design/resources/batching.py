...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/trijunction/design/resources/batching.py

Bounded pair-batch primitives shared by TriJunction search stages.
...
def upper_triangle_index_batches(
    ...
    *,
    ...
    processing one batch before requesting the next, as TriJunction's scorers do.
    """
