...
from dnadesign.trijunction.design import barcodes as _barcodes
from dnadesign.trijunction.design import matching as _matching
from dnadesign.trijunction.design import toeholds as _toeholds
...
_STRING_SEARCH_V1 = _SearchPipeline(
    algorithm_id="dnadesign.trijunction.string.v1",
