...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/trijunction/tests/performance/_factories.py

Shared test factories for TriJunction performance contracts.
...
from dnadesign.trijunction.contracts import PlanningProfile
