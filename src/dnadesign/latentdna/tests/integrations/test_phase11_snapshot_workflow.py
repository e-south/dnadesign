...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/latentdna/tests/integrations/test_phase11_snapshot_workflow.py

Phase 11 workflow tests for source snapshot row ledgers.
...
def test_phase11_snapshot_build_persists_key_rows_without_vectors(tmp_path: Path) -> None:
