...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/latentdna/tests/integrations/test_snapshot_metadata_workflow.py
...
def test_snapshot_build_persists_metadata_companion_without_vectors(tmp_path: Path) -> None:
