...
def _derive_vector_difference_artifact(
    ...
    *,
    ...
    left_matrix, _, left_manifest = _load_view_artifact(context, view.derive.left)
    right_matrix, _, right_manifest = _load_view_artifact(context, view.derive.right)
...
def derive_view_artifact(
    ...
    *,
    ...
    if view.derive.kind == "vector_difference":
        return _derive_vector_difference_artifact(context, view_id=view_id, view=view)
    if view.derive.kind == "normalize":
        return _derive_normalize_artifact(context, view_id=view_id, view=view)
    if view.derive.kind == "aggregate_by_key":
        return _derive_aggregate_by_key_artifact(context, view_id=view_id, view=view)
    if view.derive.kind == "apply_reducer":
        return _derive_apply_reducer_artifact(context, view_id=view_id, view=view)
    if view.derive.kind == "concatenate":
        return _derive_concatenate_artifact(context, view_id=view_id, view=view)
