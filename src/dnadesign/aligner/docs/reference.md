...
`aligner` computes Needleman-Wunsch global alignment scores between nucleotide
sequences. It integrates with sibling analysis tools such as LibShuffle,
Cluster, and Billboard through public Python functions.
