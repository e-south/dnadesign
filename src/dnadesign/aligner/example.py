...
from dnadesign.aligner.metrics import mean_pairwise, compute_alignment_scores, score_pairwise
...
pair_result = score_pairwise("ACCGTACGT", "ACGTCGTA", 
                             return_raw=True, 
                             return_alignment_str=True, 
