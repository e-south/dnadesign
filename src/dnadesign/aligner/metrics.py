...
def compute_alignment_scores(
    ...
    cache_filename = generate_cache_filename(n, normalize, gap_open, gap_extend, matrix_id="nt", return_formats=return_formats)
    if use_cache:
...
def score_pairwise(
    ...
    result = global_alignment(seqA, seqB, match, mismatch, gap_open, gap_extend, return_alignment_str=return_alignment_str)
