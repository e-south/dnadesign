...
class Sigma70Plugin:
    ...
    def apply(self, record: SeqRecord) -> SeqRecord:
        ...
        - Provide a 'sigma_link' guide that draws the sandwiched distance line at the
          same vertical track as the sigma boxes.
        """
        ...
        if matches:
            ...
            guides.append(
                Guide(
                    ...
                    label=label_str,
                    payload={
                        "track": 0,  # draw at same layer as sigma boxes
