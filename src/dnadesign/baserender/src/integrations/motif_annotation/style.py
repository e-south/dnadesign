...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/baserender/src/integrations/motif_annotation/style.py

Define a reusable motif-showcase style profile.
...
_MOTIF_SHOWCASE_STYLE_OVERRIDES: dict[str, object] = {
    "figure_scale": 1.60,
    "padding_y": 24.0,
    "overlay_align": "center",
    "layout": {"outer_pad_cells": 0.20},
    "sequence": {
...
def motif_showcase_style_overrides() -> dict[str, object]:
    return deepcopy(_MOTIF_SHOWCASE_STYLE_OVERRIDES)


__all__ = ["motif_showcase_style_overrides"]
