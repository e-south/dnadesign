...
Usage examples:
  ...
  $ python seqmanager.py --path densebatch_deg2tfbs_pipeline_tfbsfetcher_m9_acetate_tfs_n10000_resample20_diverse/densegenbatch_m9_acetate_tfs_n10000.pt --index 3
