...
def build_variant_sequence_view(
    *,
    ...
    forward_anchor_start_0: int | None = None,
    forward_anchor_end_0: int | None = None,
    ...
    return SequenceViewRecord(
        sequence_id=record.output_id,
        view_name=view_name or record.label_primary,
        aliases=list(record.label_aliases) if aliases is None else aliases,
        ...
        anchor_start_0=anchor_start_0,
        anchor_end_0=anchor_end_0,
        forward_anchor_start_0=forward_anchor_start_0,
        forward_anchor_end_0=forward_anchor_end_0,
        recommended_pooling=recommended_pooling,
        created_at=record.created_at,
        created_by="construct",
    )
