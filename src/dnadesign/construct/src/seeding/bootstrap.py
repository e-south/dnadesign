...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/construct/src/seeding/bootstrap.py
...
from ..persistence.usr_registry import _ensure_construct_registry
from ..workspaces.registry import project_root_or_none
