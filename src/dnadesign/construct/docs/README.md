...
- [Hand off a construct-backed source-of-truth dataset to infer](../../usr/docs/operations/construct-infer-source-of-truth-demo.md): use the shared cross-tool runbook when one USR dataset should stay canonical across construct, infer, and downstream event consumers.
