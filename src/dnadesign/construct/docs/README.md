...
- [Hand off a Construct-backed source-of-truth dataset to infer](../../usr/docs/operations/construct-infer-source-of-truth-runbook.md): use the shared cross-tool runbook when one USR dataset should stay shared across Construct, infer, and downstream event consumers.
