...
from dnadesign.infer.writeback_dispatch import run_extract_write_back
...
def test_run_extract_write_back_records_routes_to_records_writer(monkeypatch) -> None:
    ...
    monkeypatch.setattr("dnadesign.infer.writeback_dispatch.write_back_records", _records)
...
def test_run_extract_write_back_pt_file_routes_to_pt_writer(monkeypatch) -> None:
    ...
    monkeypatch.setattr("dnadesign.infer.writeback_dispatch.write_back_pt_file", _pt)
