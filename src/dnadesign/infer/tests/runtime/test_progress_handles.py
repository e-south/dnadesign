...
from dnadesign.infer.src.runtime.progress import create_progress_handle
...
def test_create_progress_handle_uses_tqdm_factory(monkeypatch) -> None:
    ...
    monkeypatch.setattr("dnadesign.infer.src.runtime.progress.resolve_tqdm_factory", lambda: (_FakeTQDM, True))
