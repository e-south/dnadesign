...
- If infer writes a bundle of `infer__...` columns, choose the one feature column or exported matrix you want to carry forward from a file or USR dataset before moving to Cluster or OPAL.
