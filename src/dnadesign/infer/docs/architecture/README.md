...
- Internal implementation tree: `src/`
  ...
  - CLI command groups: `src/cli/commands/run.py`, `src/cli/commands/extract.py`, `src/cli/commands/generate.py`, `src/cli/commands/presets.py`, `src/cli/commands/adapters.py`, `src/cli/commands/validate.py`
  ...
  - contracts and schema: `src/config.py`, `src/contracts.py`, `src/errors.py`, `src/registry.py`, `src/utils.py`
