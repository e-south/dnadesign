...
- [OPS mental model](../../../../docs/operations/model/mental-model.md): shortest correct model for planes, state semantics, and snapshot versus preflight.
- [OPS failure contract](../../../../docs/operations/contracts/failure.md): exit-code and stderr contract for CLI and automation consumers.
- [OPS status kinds](../../../../docs/operations/status/kinds.md): registry ids, status kinds, owners, scope, and required inputs.
- [OPS preflight checks](../../../../docs/operations/contracts/preflight-checks.md): generic readiness-check vocabulary used by `ops.study.yaml`.
