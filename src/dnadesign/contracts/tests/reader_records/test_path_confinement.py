...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/contracts/tests/reader_records/test_path_confinement.py
...
from dnadesign.contracts.reader_records import ReaderDataframeRecordError
from dnadesign.contracts.reader_records import transport as reader_transport
