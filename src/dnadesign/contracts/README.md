...
Use it when producers and consumers need a neutral, versioned contract surface without importing each other's tool internals. The current package focuses on cassette visual artifacts shared between `cruncher` and `baserender`.
