...
| DenseGen probe package root exports no flat aggregate API | `src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/__init__.py:1-9` |
| DenseGen probe consumes public OPAL progress and review APIs | `src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/progress.py:9-27`, `src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review.py:14-39` |
