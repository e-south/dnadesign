    ...
    return block(
        ...
        def _():
            ...
            from dnadesign.opal.notebooks.api.generated import (
                ...
                build_notebook_baserender_evidence_bundle, build_notebook_baserender_label_rows,
                ...
                render_notebook_plot_choice_image, render_notebook_reader_evidence_record_control,
            ...
            return (
                ...
                build_notebook_validity_rows,
                build_notebook_visual_group_options, build_notebook_visual_surface_model,
                filter_notebook_visual_choices_by_group, generated_with,
                load_notebook_baserender_campaign_context,
                mo, opal_table, pl,
                render_notebook_baserender_record,
                render_notebook_campaign_set_selection_overlap_image, render_notebook_plot_choice_image,
                render_notebook_reader_evidence_record_control, render_notebook_reader_evidence_artifact_visual,
                render_notebook_reader_evidence_panel,
                render_notebook_review_control_surface, render_notebook_visual_panel,
                read_notebook_layered_scatter_state, resolve_notebook_baserender_campaign_model,
                resolve_notebook_baserender_selection_view_id,
                resolve_notebook_baserender_candidate_record,
                resolve_notebook_baserender_selection_batch_scope,
                resolve_notebook_selection_view,
