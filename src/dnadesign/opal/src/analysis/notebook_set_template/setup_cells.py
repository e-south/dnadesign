    ...
    return block(
        ...
        def _():
            ...
            from dnadesign.opal.notebooks.api.generated import (
                ...
                annotate_notebook_visual_choices, available_rounds,
                ...
                build_notebook_baserender_label_rows, build_notebook_baserender_review_state,
                ...
                build_notebook_selected_baserender_records, build_notebook_validity_rows,
