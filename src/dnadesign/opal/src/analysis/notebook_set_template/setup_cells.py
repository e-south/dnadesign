    ...
    return block(
        ...
        def _():
            ...
            from dnadesign.opal.notebooks.api.generated import (
                CAMPAIGN_SET_BASERENDER_SURFACE_KIND, CampaignAnalysis, available_rounds,
                ...
                build_notebook_baserender_label_rows, build_notebook_campaign_header_lines,
                build_notebook_campaign_summary_row, build_notebook_change_rows,
                build_notebook_change_summary_rows, build_notebook_collection_baserender_role_choices,
                build_notebook_collection_set_choices, build_notebook_collection_visual_card_rows,
                build_notebook_collection_visual_choices,
                build_notebook_collection_visual_description as collection_visual_description,
                build_notebook_evidence_rows, build_notebook_label_staging_rows,
                build_notebook_metric_definition_rows, build_notebook_plot_card_rows,
                build_notebook_plot_method_sections, build_notebook_plot_scope_options,
                build_notebook_run_options, build_notebook_validity_rows,
                build_notebook_visual_surface_model, latest_round, latest_run_id,
                ...
                resolve_notebook_round_default, select_notebook_baserender_default_record_id,
            ...
            return (
                Path, CAMPAIGN_SET_BASERENDER_SURFACE_KIND, CampaignAnalysis, available_rounds,
                build_campaign_set_notebook_view_model, build_notebook_artifact_garden_rows,
                build_notebook_artifact_garden_summary_rows, build_notebook_at_a_glance_rows,
                build_notebook_baserender_contract, build_notebook_baserender_contract_rows,
                build_notebook_baserender_label_rows, build_notebook_campaign_header_lines,
                ...
                build_notebook_change_summary_rows, build_notebook_collection_baserender_role_choices,
                build_notebook_collection_set_choices, build_notebook_collection_visual_card_rows,
                build_notebook_collection_visual_choices, collection_visual_description,
                build_notebook_evidence_rows, build_notebook_label_staging_rows,
                build_notebook_metric_definition_rows, build_notebook_plot_card_rows,
                build_notebook_plot_method_sections, build_notebook_plot_scope_options,
                build_notebook_run_options, build_notebook_validity_rows, build_notebook_visual_surface_model,
                generated_with, latest_round, latest_run_id, load_notebook_baserender_record_row, mo, opal_table, pl,
