...
```bash
uv run python -m dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.candidate_table \
  --config src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/sampling.yaml
```
...
```bash
uv run python -m dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.provenance \
  --config src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/sampling.yaml
```
...
```bash
uv run python -m dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.select \
  --config src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/sampling.yaml
```
