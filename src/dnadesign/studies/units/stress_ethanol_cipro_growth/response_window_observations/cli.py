...
def _preview_payload(evidence: ResponseWindowObservationEvidence) -> dict[str, object]:
    ...
    return {
        ...
        "comparable_repeated_candidate_count": int(status_counts.get("comparable", 0)),
        "excluded_noncomparable_candidate_count": int(status_counts.get("excluded_noncomparable", 0)),
