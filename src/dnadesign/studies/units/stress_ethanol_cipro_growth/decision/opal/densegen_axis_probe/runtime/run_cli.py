...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/decision/opal/densegen_axis_probe/runtime/run_cli.py
...
from ..core.constants import DEFAULT_SUITE_ID, NULL_ORACLE_ID, ORACLE_ID, RUN_STAGES
from ..core.paths import _default_run_root, _repo_root_from, _resolve_repo_path, validate_run_root_policy
from ..core.source_contract import validate_candidate_x_surface
...
from ..evaluation.decision_evaluation import _evaluate_run, _evaluate_run_rounds
from ..evaluation.decision_inputs import (
    _compact_split_metadata,
    _format_plan_text,
    _source_summary,
    _split_metadata_for_all,
)
from ..evaluation.decision_report import write_decision
from ..plan_logic.axis_oracle import build_axis_oracle, make_permuted_labels
from ..plan_logic.label_families import label_family_manifest
from ..plan_logic.nulls import null_provenance_payload
from ..reporting.status import _format_status_text, audit_run_root
from ..reporting.suite_manifest import suite_manifest_payload
