...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/decision/opal/densegen_axis_probe/reporting/review/rendering/html_document.py
...
from .formatting import _e, _fmt, _gate_observed, _gate_threshold, _html_document, _metric_card
from .outcome import html_outcome_section
from .plot_cards import campaign_links_html, configured_plot_cards_html, probe_plot_cards_html
...
def render_probe_review_html(
    ...
    *,
    ...
    probe_plot_cards = probe_plot_cards_html(plots, base_dir=base_dir)
    campaign_links = campaign_links_html(campaign_reviews, base_dir=base_dir)
    metric_rows = []
    for row in runs:
    ...
    configured_plot_cards = configured_plot_cards_html(configured_plots, base_dir=base_dir)
    ...
    probe_plot_cards_body = probe_plot_cards or "<p>No probe aggregate plots written.</p>"
    ...
    <main>
      ...
      {html_outcome_section(outcome_summary)}
      <section>
      ...
      <section>
        <h2>Probe Plots</h2>
        <div class="plot-grid">{probe_plot_cards_body}</div>
      </section>
      <section>
        ...
        {configured_plot_next_step_html}
        <div class="plot-grid">{configured_plot_cards}</div>
      </section>
      <section>
        <h2>Scored Runs</h2>
        <table>
      ...
      <section>
        ...
        <ul>{campaign_links if campaign_links else "<li>No OPAL campaign reviews written.</li>"}</ul>
      </section>
    </main>
    """
