...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/decision/opal/densegen_axis_probe/plan_logic/axis_oracle.py
...
from ..core.artifacts import AxisLabel
...
def derive_axis_label(row: Mapping[str, Any]) -> AxisLabel:
    ...
    unsupported_plan = bool(plan_base and expected is None)
