...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/decision/opal/response_metastudy/runtime/multistate_behavior_bundle_verification_v2.py

Fail-closed verification for self-contained v2 behavior shadow bundles.
...
_PROTOCOL_ID = "secg_multistate_response_behavior_shadow_v2"
_PROTOCOL_PATH = Path(__file__).resolve().parents[1] / "config/multistate_response_behavior_shadow_v2.yaml"
...
def verify_multistate_behavior_shadow(bundle_root: Path) -> dict[str, object]:
    ...
    if protocol_id != _PROTOCOL_ID:
        raise ValueError("multistate behavior v2 bundle protocol identity disagrees.")
