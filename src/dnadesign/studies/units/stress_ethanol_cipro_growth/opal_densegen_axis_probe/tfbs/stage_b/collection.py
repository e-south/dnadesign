...
def stage_b_collection_manifest(*, split_id: str, seed: int) -> dict[str, Any]:
    ...
    return {
        ...
        "dimensions": [
            ...
            {"id": "label_oracle_kind", "label": "Oracle kind"},
        ...
        # The TFBS probe endpoint is realized oracle-label enrichment, not
