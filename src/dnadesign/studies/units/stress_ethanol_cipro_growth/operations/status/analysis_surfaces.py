...
def inspect_stress_ethanol_cipro_growth_exploratory_analysis(
    *,
...
def _inspect_latentdna_surface(
    *,
    ...
    payload: dict[str, object] = {
        ...
        "appendix_entry_artifacts": dict((latentdna_state or {}).get("appendix_source_datasets") or {}),
        "appendix_state": _string_or_none((latentdna_state or {}).get("appendix_state")),
        "appendix_summary": _string_or_none((latentdna_state or {}).get("appendix_summary")),
        "missing_appendix_source_datasets": list((latentdna_state or {}).get("missing_appendix_source_datasets") or []),
