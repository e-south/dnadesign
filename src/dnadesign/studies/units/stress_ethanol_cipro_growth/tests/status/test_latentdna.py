...
from dnadesign.studies.units.stress_ethanol_cipro_growth.status.analysis_surfaces import (
    inspect_stress_ethanol_cipro_growth_exploratory_analysis,
)
from dnadesign.studies.units.stress_ethanol_cipro_growth.status.latentdna_contract import (
    validate_binding,
    validate_workspace_snapshot,
)
from dnadesign.studies.units.stress_ethanol_cipro_growth.status.latentdna_readiness import (
...
def test_stress_ethanol_cipro_latentdna_status_modules_do_not_import_latentdna_internals() -> None:
    ...
    for relative_path in [
        "src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/latentdna_readiness.py",
