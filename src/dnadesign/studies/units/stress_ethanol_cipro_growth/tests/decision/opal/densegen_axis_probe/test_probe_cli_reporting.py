...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/tests/decision/opal/densegen_axis_probe/test_probe_cli_reporting.py

Regression tests for probe CLI reporting studies units stress ethanol cipro.
...
def test_probe_plot_json_redirects_noisy_generation_stdout(
    ...
    probe_main = probe_module("cli").main
    plotting = probe_module("reporting.plotting")
...
def test_probe_report_json_redirects_noisy_review_stdout(
    ...
    probe_main = probe_module("cli").main
    review = probe_module("reporting.review")
