...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/tests/decision/opal/densegen_axis_probe/test_tfbs_stage_b_claims.py

Regression tests for TFBS stage b claims studies units stress ethanol.
...
build_tfbs_stage_b_claim_assessment = probe_module("tfbs.stage_b.claims").build_tfbs_stage_b_claim_assessment
