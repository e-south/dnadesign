...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/tests/decision/opal/densegen_axis_probe/test_planning_contracts.py

Regression tests for planning studies units stress ethanol cipro growth decision.
...
def test_probe_dry_run_json_reports_planned_plan_path_without_artifact_claim(
    ...
    run_cli = probe_module("runtime.run_cli")
