...
from dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.candidate_table import (
...
from dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.provenance import (
    audit_candidate_lineage,
    show_candidate_lineage,
)
from dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.select import (
...
SAMPLING = REPO_ROOT / "src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/sampling.yaml"
CAMPAIGN_ROOT = REPO_ROOT / "src/dnadesign/opal/campaigns"
STUDY_DOCS = REPO_ROOT / "docs/studies/stress_ethanol_cipro_growth"
BATCH0_README = REPO_ROOT / "src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/README.md"
