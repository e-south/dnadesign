...
def test_probe_package_root_exports_no_flat_api_surface() -> None:
    package = importlib.import_module("dnadesign.studies.units.stress_ethanol_cipro_growth.opal_densegen_axis_probe")
...
def test_cli_import_keeps_status_path_run_stack_lazy() -> None:
    module = "dnadesign.studies.units.stress_ethanol_cipro_growth.opal_densegen_axis_probe.cli"
    script = (
        "import sys; "
        f"import {module}; "
...
def test_probe_review_is_semantic_package() -> None:
    probe_root = Path("src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe")
...
def test_probe_tests_are_semantic_package() -> None:
    ...
    test_package = (
        Path("src/dnadesign/studies/units") / "stress_ethanol_cipro_growth" / "tests" / "opal_densegen_axis_probe"
    )
