...
from dnadesign.studies.units.stress_ethanol_cipro_growth.opal_densegen_axis_probe.tfbs.stage_a.materialization import (
    TfbsStageAConfig,
    materialize_tfbs_stage_a,
)
from dnadesign.studies.units.stress_ethanol_cipro_growth.opal_densegen_axis_probe.tfbs.stage_b.configs import (
    TfbsStageBConfig,
    materialize_tfbs_stage_b_sentinel_configs,
)
from dnadesign.studies.units.stress_ethanol_cipro_growth.tests.opal_densegen_axis_probe.stage_b_fixtures import (
    write_tfbs_stage_b_source_fixture,
)
...
def test_tfbs_stage_b_cli_generates_configs_from_stage_a_run_root(
    ...
    from dnadesign.studies.units.stress_ethanol_cipro_growth.opal_densegen_axis_probe.cli import main
