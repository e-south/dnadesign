...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/stress_ethanol_cipro_growth/tests/operations/status/test_densegen.py

Stress ethanol cipro status DenseGen seam tests.
...
def test_inspect_stress_ethanol_cipro_growth_exploratory_analysis_uses_public_densegen_surface_contract(
    tmp_path: Path,
) -> None:
...
def test_stress_ethanol_cipro_densegen_surface_reports_explicit_degraded_state_when_contract_load_fails(
    tmp_path: Path,
) -> None:
...
def test_stress_ethanol_cipro_analysis_surface_module_does_not_import_densegen_internals() -> None:
    repo_root = repo_root_from(__file__)
    source = (
        repo_root / "src/dnadesign/studies/units/stress_ethanol_cipro_growth/operations/status/analysis_surfaces.py"
