...
def validate_source_sequence_bundle_sufficiency(
    *,
    ...
    context = SourceSequenceSufficiencyContext(
        repo_root=root,
        output_root=resolve_path(root, output_root or DEFAULT_OUTPUT_ROOT),
        source_cache_root=resolve_path(root, source_cache_root or DEFAULT_SOURCE_CACHE_ROOT),
        bundle_root=resolve_path(root, bundle_root or DEFAULT_SOURCE_BUNDLE_ROOT),
