...
CLI for Eco1 RT generation-policy materialization.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Materialize Eco1 RT generation-policy manifests and ProteinMPNN request sidecars."
    )
    ...
    subparsers.add_parser("foldcheck-request", help="Write a ColabFold-ready FASTA and fold-check manifest.")
