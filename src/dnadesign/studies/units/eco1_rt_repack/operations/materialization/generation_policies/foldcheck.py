...
Materialize Eco1 RT generation-policy fold-check inputs.
...
_ARTIFACT_ID = f"eco1_rt_generation_policies_v{GENERATION_POLICY_VERSION}.foldcheck_request"
...
def materialize_generation_policy_foldcheck_request(
    *,
    ...
    """Materialize a ColabFold-ready FASTA and request manifest for active-policy candidates."""
