...
PLAIN_DELIVERABLE_TITLES = {
    ...
    "selected_panel_structure_browser_manifest": "Selected protein hypotheses can be inspected one at a time",
    ...
    "selection_funnel_summary": "Selection flow keeps activity claims separate",
    "selection_panel_table": "Eight selected Eco1 RT sequences",
