...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/review_deliverables/msa_panel_annotations.py

RT annotation span drawing for Eco1 MSA review panels.
...
def add_rt_annotation_context(ax: Any, positions: list[int], *, context: RTAnnotationContext) -> None:
