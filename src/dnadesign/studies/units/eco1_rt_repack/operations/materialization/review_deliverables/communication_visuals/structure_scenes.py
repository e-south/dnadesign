...
SCENE_KIND_NATIVE = "native_complex"
SCENE_KIND_FIXED = "fixed_positions"
SCENE_KIND_DESIGN = "design_spaces"
...
def structure_scene_specs(rows: list[dict[str, Any]]) -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        _scene(
            ...
            "NAxxH, YADD, and VTG context windows",
            "2 Protected evidence",
            SCENE_KIND_FIXED,
            "Three declared context windows around the literature-annotated motif anchors remain fixed.",
        ...
        _scene(
            ...
            "2 Protected evidence",
            SCENE_KIND_FIXED,
            "Eight Wang-described thumb-track positions remain fixed.",
            _positions_with_value(context_rows, "is_wang_thumb_track"),
            THUMB_COLOR,
        ),
        _scene(
