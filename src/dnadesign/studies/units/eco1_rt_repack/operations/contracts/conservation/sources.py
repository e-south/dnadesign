...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/eco1_rt_repack/operations/contracts/conservation/sources.py
...
from dnadesign.studies.units.eco1_rt_repack.operations.contracts.conservation.source_selection import (
