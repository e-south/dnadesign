...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/units/retron_hairpin_design/interfaces/cli/app.py
...
from .msd_region_ingest import ingest_msd_regions_command
...
app.command("ingest-msd-regions")(ingest_msd_regions_command)
...
def materialize_command(
    ...
    try:
        ...
        if spec_file is None:
            ...
            resolved_payload_complement_sequences: dict[str, str] = {}
            ...
            resolved_payload_complement_sequences = resolved.payload_complement_sequences
        ...
        result = materialize_msd_design_artifacts(
            ...
            payload_complement_sequences=resolved_payload_complement_sequences,
