...
KHAN_SEQUENCE_AUTHORITY_PATH = (
    LITERATURE_DIR / "Khan_et_al_2024_retron_census" / "processed/references/rt_lnrna_sequence_authority.tsv"
)
...
def resolve_khan_promotions(
    *,
    ...
    rows = read_tsv(data_root / KHAN_SEQUENCE_AUTHORITY_PATH)
    source_row_counts[str(KHAN_SEQUENCE_AUTHORITY_PATH)] = len(rows)
    ...
    for row in rows:
        ...
        promotions.append(
            SourceConstructSubjectPromotion(
                ...
                lnrna_sequence=lnrna_sequence,
                rt_cds_sequence=rt_cds_sequence,
                source_basis="khan_source_rt_lnrna_reference",
                source_collection_id=KHAN_COLLECTION_ID,
                source_record_id=record_id,
...
def _khan_overlay_fields(
    *,
    ...
    return {
        ...
        "construct_subject__variant_class": "khan_source_rt_lnrna_reference",
        "construct_subject__construct_projection_status": "representable",
        "construct_subject__source_basis": "khan_source_rt_lnrna_reference",
