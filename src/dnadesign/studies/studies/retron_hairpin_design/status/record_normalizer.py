...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/studies/retron_hairpin_design/status/record_normalizer.py

Thin checked-in record normalization for Retron hairpin design study status snapshots.
...
class RetronHairpinDesignCommandGroup:
    id: str
    purpose: str | None
...
@dataclass(frozen=True)
class RetronHairpinDesignResolvedContext:
    ...
    command_groups: tuple[RetronHairpinDesignCommandGroup, ...]
...
def resolve_retron_hairpin_design_context(
    study_root: Path | str | None,
    *,
    repo_root: Path | None,
    status_kind: str,
) -> RetronHairpinDesignResolvedContext:
    ...
    return RetronHairpinDesignResolvedContext(
...
def _load_command_groups(
    ...
    *,
    ...
    for index, item in enumerate(payload, start=1):
        ...
        groups.append(
            RetronHairpinDesignCommandGroup(
                id=group_id,
...
__all__ = [
    "RetronHairpinDesignCommandGroup",
    "RetronHairpinDesignResolvedContext",
    "resolve_retron_hairpin_design_context",
]
