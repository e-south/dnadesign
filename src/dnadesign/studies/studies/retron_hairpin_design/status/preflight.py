...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/studies/retron_hairpin_design/status/preflight.py

Read-only preflight coordination for Retron hairpin design study status records.
...
class RetronHairpinDesignPreflightResolvedContext:
...
@dataclass(frozen=True)
class RetronHairpinDesignPreflightDependencies:
...
def resolve_retron_hairpin_design_preflight_context(
    *,
    study_context: RetronHairpinDesignResolvedContext,
    scope: str | None,
    contract: StudyOpsContract,
) -> RetronHairpinDesignPreflightResolvedContext:
    ...
    return RetronHairpinDesignPreflightResolvedContext(
...
def build_retron_hairpin_design_preflight_progress(
    *,
    context: RetronHairpinDesignPreflightResolvedContext,
