...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/studies/studies/stress_ethanol_cipro_growth/status/record_normalizer.py
...
class StressEthanolCiproGrowthContextDependencies:
...
@dataclass(frozen=True)
class StressEthanolCiproGrowthResolvedContext:
...
def resolve_stress_ethanol_cipro_growth_context(
    study_dir: Path | None,
    *,
