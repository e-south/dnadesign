...
under the Retron study because it normalizes study-selected construct labels and
emits frozen `msd_design_reference_v1` / `msd_design_catalog_v1` records for
downstream tools such as Reader. Construct and Folding remain workspace-less or
