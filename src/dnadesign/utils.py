...
DATA_FILES = {
    ...
    "han_et_al_known_interactions": DNADESIGN_DATA
    / "primary_literature"
    / "Han_et_al"
    / "41467_2023_41572_MOESM9_ESM.xlsx",
    "han_et_al_pptp_seq_interactions": DNADESIGN_DATA
    / "primary_literature"
    / "Han_et_al"
    / "41467_2023_41572_MOESM8_ESM.xlsx",
    ...
    "johns_et_al_sequences": DNADESIGN_DATA
    / "primary_literature"
    / "Johns_et_al"
    / "41592_2018_BFnmeth4633_MOESM3_ESM.xlsx",
    "johns_et_al_labels": DNADESIGN_DATA
    / "primary_literature"
    / "Johns_et_al"
    / "41592_2018_BFnmeth4633_MOESM5_ESM.xlsx",
    ...
    "regulondb_13_promoter_FecI_set": DNADESIGN_DATA
    / "RegulonDB_13"
    / "promoters"
    / "FecI_RDBECOLISFC00002_SigmulonPromoters.csv",
    "regulondb_13_promoter_FliA_set": DNADESIGN_DATA
    / "RegulonDB_13"
    / "promoters"
    / "FliA_RDBECOLISFC00001_SigmulonPromoters.csv",
    "regulondb_13_promoter_RpoD_set": DNADESIGN_DATA
    / "RegulonDB_13"
    / "promoters"
    / "RpoD_RDBECOLISFC00003_SigmulonPromoters.csv",
    "regulondb_13_promoter_RpoE_set": DNADESIGN_DATA
    / "RegulonDB_13"
    / "promoters"
    / "RpoE_RDBECOLISFC00004_SigmulonPromoters.csv",
    "regulondb_13_promoter_RpoH_set": DNADESIGN_DATA
    / "RegulonDB_13"
    / "promoters"
    / "RpoH_RDBECOLISFC00005_SigmulonPromoters.csv",
    "regulondb_13_promoter_RpoN_set": DNADESIGN_DATA
    / "RegulonDB_13"
    / "promoters"
    / "RpoN_RDBECOLISFC00006_SigmulonPromoters.csv",
    "regulondb_13_promoter_RpoS_set": DNADESIGN_DATA
    / "RegulonDB_13"
    / "promoters"
    / "RpoS_RDBECOLISFC00007_SigmulonPromoters.csv",
    # EcoCyc Transcription Factor Binding Site SmartTable(s)
    "ecocyc_28_tf_binding_sites": DNADESIGN_DATA
    / "EcoCyc_28"
...
def generate_sequence_entry(dense_array_solution, source_names: list, tfbs_parts: list, config: dict) -> dict:
    ...
    entry = {
        ...
        "offset_indices_in_order": (
            dense_array_solution.offset_indices_in_order()
            if hasattr(dense_array_solution, "offset_indices_in_order")
            else None
        ),
...
def load_dataset(dataset_key, sheet_name=None, usecols=None, header=0, skiprows=None):
    ...
    if file_path.suffix in [".xlsx", ".xls"]:
        df = pd.read_excel(file_path, sheet_name=sheet_name, usecols=usecols, header=header, skiprows=skiprows)
