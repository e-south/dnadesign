...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/junction/design/randomness.py
...
def derive_seed(seed: int, *, assembly_group_id: str, stage: str) -> int:
    """Derive an ordering-independent 64-bit seed for one assembly-group stage."""

    payload = f"dnadesign.junction.seed.v1\0{seed}\0{assembly_group_id}\0{stage}".encode()
...
class StablePrng:
    ...
    releases.  junction owns this small stream and the Fisher-Yates/rejection
