...
--------------------------------------------------------------------------------
dnadesign
src/dnadesign/junction/tests/performance/test_hot_path_correctness.py

Reference-equivalence contracts for deterministic junction hot paths.
...
from dnadesign.junction.design.matching import _matching_score
from dnadesign.junction.design.randomness import StablePrng
from dnadesign.junction.sequence import longest_common_substring_length
from dnadesign.junction.tests.performance._factories import candidate
