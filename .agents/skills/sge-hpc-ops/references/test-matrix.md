...
| --- | --- | --- | --- |
| Trigger positive | "Submit this qsub job on BU SCC." | Skill activates SGE workflow with route selection, capability probing, and verify-before-submit guidance | Pass if output includes `route_id`, capability snapshot, and submit-gate steps before any submit command |
