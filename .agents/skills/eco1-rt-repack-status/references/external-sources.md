...
| Wang et al. 2022, Nature Microbiology, DOI `10.1038/s41564-022-01197-7` | 2026-07-15 | Eco1/Ec86 cryo-EM structure prior for RT-msDNA/msrRNA context, active-site/motif context, RT1-RT7 interval spans, and the F10/R13 cross-protomer interface. R13A disrupted the interaction while retaining msDNA and the tested antiphage phenotype; related Sen2 and Eco9 RT-msDNA complexes were monomeric. | A claim that a one-chain model or an untested F10/R13 substitution establishes monomeric assembly, a claim that every alpha-1 substitution is harmless, or permission to redesign substrate-contact residues. |
| Inouye et al. 1999, Journal of Biological Chemistry, DOI `10.1074/jbc.274.44.31236` | 2026-07-07 | Primary Ec86 prior that the C-terminal RT region contributes to cognate primer-template RNA recognition and branch-G initiation context. | A strand-displacement score, a reason to relax thumb-contact protection, or a complete residue-level mask authority. |
| Inouye et al. 2004, Journal of Biological Chemistry, DOI `10.1074/jbc.M408462200` | 2026-07-07 | Primary Ec86 prior for treating the 255-320 C-terminal/thumb fragment as a primer-recognition RNA-binding context. | Evidence that direct thumb-track substitutions are conservative or that charge alone predicts cognate RNA specificity. |
...
| Kabsch 1976, Acta Crystallographica, DOI `10.1107/S0567739476001873` | 2026-07-07 | Method prior for using one optimal rigid-body C-alpha superposition before inspecting regional residual shifts. | A local RMSD threshold source or evidence for RT activity. |
| Kabsch 1978, Acta Crystallographica, DOI `10.1107/S0567739478001680` | 2026-07-07 | Method prior for least-squares coordinate superposition used by mapped-structure RMSD checks. | A local RMSD threshold source or evidence for RT activity. |
