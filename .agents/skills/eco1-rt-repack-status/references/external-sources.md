...
| Wang et al. 2022, Nature Microbiology, DOI `10.1038/s41564-022-01197-7` | 2026-07-12 | Eco1/Ec86 cryo-EM structure prior for RT-msDNA/msrRNA context, active-site/motif context, RT1-RT7 interval spans, and the alpha-1/R13 protomer interface. R13A disrupted the protomer contact while retaining msDNA production and antiphage defence; alpha-1 is not conserved in the related Sen2 and Eco9 complexes. | An exact-WT R13 gate, a claim that every alpha-1 substitution is harmless, or permission to redesign substrate-contact residues. |
