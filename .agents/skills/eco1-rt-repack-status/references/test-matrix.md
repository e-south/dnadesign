...
| Conservation routing | What blocks conservation masking? | Route to the MSA method, conservation source contract, and conservation materializer. | Pass if the answer says aligned FASTA inputs are still missing and does not imply live fetch/alignment fallback. |
