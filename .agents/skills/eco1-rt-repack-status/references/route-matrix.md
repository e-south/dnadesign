...
| What blocks conservation masking? | `src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/source_sequences/roster_cache/`, `src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/source_sequences/`, `src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/conservation/`, `src/dnadesign/aligner/msa/`, and `contexts/msa-method.md` | Roster-cache, source-sequence, source-bundle sufficiency, conservation-profile, and generic MAFFT bundle seams exist, but real Mestre/provider source inputs, sufficiency-passing source FASTA bundles, aligned FASTA inputs, and conservation profile are still missing. |
