...
| What blocks conservation masking? | `src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/source_sequences/provider_sources/`, `src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/source_sequences/roster_cache/`, `src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/source_sequences/`, `src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/conservation/`, `src/dnadesign/aligner/msa/`, and `contexts/msa-method.md` | Provider-source, roster-cache, source-sequence, source-bundle sufficiency, conservation-profile, and generic MAFFT bundle seams exist. Local source FASTA bundles pass sufficiency; aligned FASTA inputs and conservation profile are still missing. |
