...
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/densegen.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/infer.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/construct.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/cluster.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/opal.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/latentdna.md"
...
require_pattern 'routes/opal\.md' "skill routes OPAL detail after one-hop map"
require_pattern 'routes/latentdna\.md' "skill routes LatentDNA detail after one-hop map"
...
require_max_lines "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/densegen.md" 80 "DenseGen route detail stays bounded"
require_max_lines "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/infer.md" 80 "Infer route detail stays bounded"
require_max_lines "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/construct.md" 80 "Construct route detail stays bounded"
require_max_lines "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/cluster.md" 80 "Cluster route detail stays bounded"
require_max_lines "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/opal.md" 100 "OPAL route detail stays bounded"
require_max_lines "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes/latentdna.md" 120 "LatentDNA route detail stays bounded"
