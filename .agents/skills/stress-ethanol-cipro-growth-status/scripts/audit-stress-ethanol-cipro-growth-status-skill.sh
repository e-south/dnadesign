...
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/ops/status.registry.yaml"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/service.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/snapshot.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/preflight.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/probes/runtime_dependencies.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/probes/semantic_completeness.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/probes/sequence_view_contracts.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/README.md"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/__init__.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/__main__.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/axis_oracle.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/decision.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/prediction_ledger.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/progress.py"
require_dir "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review/__init__.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review/builder.py"
require_file "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/status.py"
...
require_pattern 'latentdna\.readiness\.semantic' "preflight provider emits LatentDNA semantic readiness check" "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/preflight.py"
require_pattern 'missing_source_datasets' "preflight provider emits LatentDNA missing-source details" "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/preflight.py"
require_pattern 'LatentDNA primary readiness attention' "LatentDNA readiness summary reports primary attention" "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/latentdna_readiness.py"
require_pattern 'missing_appendix_source_datasets' "LatentDNA readiness exposes appendix drift separately" "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/latentdna_readiness.py"
...
require_pattern '__all__: list\[str\] = \[\]' "DenseGen probe package root exports no flat aggregate API" "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/__init__.py"
require_pattern 'python -m dnadesign\.studies\.units\.stress_ethanol_cipro_growth\.opal_densegen_axis_probe report --run-root' "DenseGen probe context documents runnable report command" "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/contexts/opal/densegen-axis-probe-v0.md"
require_pattern 'python -m dnadesign\.studies\.units\.stress_ethanol_cipro_growth\.opal_densegen_axis_probe progress --run-root' "DenseGen probe context documents runnable progress command" "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/contexts/opal/densegen-axis-probe-v0.md"
...
require_tree_absent 'dnadesign\.opal\.src' "DenseGen probe uses public OPAL API only" "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe"
...
if [[ -e "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review.py" ]]; then
  fail "DenseGen probe review is a semantic package"
else
  pass "DenseGen probe review is a semantic package"
fi

require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/service.py" 320 "status service stays orchestration-sized"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/probes/runtime_dependencies.py" 140 "runtime probe module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/probes/semantic_completeness.py" 200 "semantic-completeness probe module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/status/probes/sequence_view_contracts.py" 240 "sequence-view probe module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/axis_oracle.py" 450 "DenseGen axis-oracle module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/decision.py" 450 "DenseGen probe decision module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/prediction_ledger.py" 120 "DenseGen probe prediction-ledger module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/cli.py" 280 "DenseGen probe CLI module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/status.py" 220 "DenseGen probe status module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review/builder.py" 180 "DenseGen probe review builder stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review/configured_plots.py" 260 "DenseGen probe review configured-plot module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review/probe_plots.py" 360 "DenseGen probe review plot module stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review/rendering/html.py" 320 "DenseGen probe review HTML renderer stays bounded"
require_max_lines "$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_densegen_axis_probe/review/rendering/markdown.py" 240 "DenseGen probe review Markdown renderer stays bounded"
