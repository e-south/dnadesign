...
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/status-contract.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/preflight.md"
...
require_max_lines "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/routes.md" 140 "stress study route map stays one-hop"
