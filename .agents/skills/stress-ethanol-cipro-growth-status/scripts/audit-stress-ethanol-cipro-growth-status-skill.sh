...
SFXI_SRC="$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/decision/opal/response_metastudy"
MSRB_DECISION="$REPO_ROOT/src/dnadesign/studies/units/stress_ethanol_cipro_growth/decision/opal/multistate_response_behavior"
MSRB_CAMPAIGN="$REPO_ROOT/src/dnadesign/opal/campaigns/secg_msrb_greedy"
failures=0
...
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/operations/contract/surfaces/execution/commands/opal/candidate-table.yaml"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/operations/contract/surfaces/execution/commands/opal/round0-review.yaml"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/operations/contract/surfaces/execution/commands/opal/campaign-inspection.yaml"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/operations/contract/surfaces/execution/commands/opal/synthesis-handoffs.yaml"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/operations/contract/surfaces/execution/commands/opal/densegen-axis-probe.yaml"
...
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/contexts/opal/response-metastudy.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/contexts/opal/response-magnitude-feasibility.md"
require_file "$REPO_ROOT/docs/studies/stress_ethanol_cipro_growth/contexts/opal/multistate-response-behavior.md"
...
require_file "$SFXI_SRC/README.md"
require_file "$SFXI_SRC/runtime/audit.py"
require_file "$SFXI_SRC/evaluation/model_validation.py"
require_file "$SFXI_SRC/reporting/plot_catalog.py"
require_file "$MSRB_DECISION/README.md"
require_file "$MSRB_DECISION/protocol.yaml"
require_file "$MSRB_DECISION/activation_audit.json"
require_file "$MSRB_CAMPAIGN/README.md"
require_file "$MSRB_CAMPAIGN/configs/campaign.yaml"
...
require_section "## Progressive Disclosure Resources"
...
require_pattern '^## Progressive Disclosure Resources$' "skill exposes progressive-disclosure references"
...
require_pattern 'contexts/opal/response-metastudy\.md' "skill routes SFXI review after OPAL selection"
require_pattern 'contexts/opal/multistate-response-behavior\.md' "skill routes active MSRB review after OPAL selection"
require_pattern 'contexts/opal/response-magnitude-feasibility\.md' "skill routes frozen RMF comparator review after OPAL selection"
require_pattern 'multistate_response_behavior/protocol\.yaml' "skill names the study-owned MSRB source protocol"
...
require_tree_absent 'dnadesign\.opal\.(api|src)' "response metric metastudy uses the top-level OPAL facade" "$SFXI_SRC"
require_absent 'core/math\.py' "response metric metastudy does not advertise duplicated metric math" "$SFXI_SRC/README.md"
...
require_max_lines "$SFXI_SRC/runtime/audit.py" 360 "response metric metastudy orchestration stays bounded"
require_max_lines "$SFXI_SRC/evaluation/model_validation.py" 240 "SFXI model validation stays bounded"
require_max_lines "$SFXI_SRC/reporting/plot_catalog.py" 280 "SFXI plot catalog stays bounded"
