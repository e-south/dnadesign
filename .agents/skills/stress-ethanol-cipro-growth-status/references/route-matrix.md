...
| The study record is missing or inconsistent. | `docs/studies/README.md` plus `status-contract.md` | Fail visibly, repair the selector or record, then rerun status. |
