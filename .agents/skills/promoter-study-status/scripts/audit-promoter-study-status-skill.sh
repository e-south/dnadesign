...
require_pattern 'Which study files are authoritative' "skill includes authority trigger coverage"
...
require_pattern 'Blank-thread bootstrap' "refresh loop includes blank-thread bootstrap" "$REFERENCE_DIR/refresh-loop.md"
require_pattern 'Fail visibly when' "refresh loop defines minimum evidence and failure routing" "$REFERENCE_DIR/refresh-loop.md"
