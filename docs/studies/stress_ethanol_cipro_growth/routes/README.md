...
- The OPAL response metric metastudy currently promotes no replacement selection policy;
  the study remains pre-assay while the OPAL route is in metric review.
