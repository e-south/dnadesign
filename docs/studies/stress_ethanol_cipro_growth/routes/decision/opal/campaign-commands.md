...
- Candidate-table contract audit: `uv run python -m dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.candidate_table --config src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/sampling.yaml --validate-existing`
- Candidate provenance audit: `uv run python -m dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.provenance --config src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/sampling.yaml`
- Per-ID provenance trace: `uv run python -m dnadesign.studies.units.stress_ethanol_cipro_growth.opal_batch0.provenance --config src/dnadesign/studies/units/stress_ethanol_cipro_growth/opal_batch0/sampling.yaml --id <candidate_id>`
