...
| Selection readiness | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/selection_readiness/` and the v3 `selection/selection_readiness_manifest.yaml` | materialized flow: 1007 complete sequences, 738 local-geometry pass, design groups of 335 distal, 226 peripheral, and 177 combined rows, then eight selected sequences; exact F10/R13 states are reported, while RT-msDNA oligomeric state is not established |
