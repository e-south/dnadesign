...
| Fold-check review | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/foldcheck_review/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/foldcheck_review/` | materialized locally; ranks 96 candidates, separates WT-runtime RMSD from direct cryoEM-reference RMSD, stages a selected review panel, stages a full local 97-PDB fold set for ChimeraX, and writes an Atlas subset manifest plus alt-text-backed review plots and a scoped marimo notebook without accepting candidates |
| Review deliverables | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/review_deliverables/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/` | materialized foundation bundle; writes a manifest-relative visual manifest, MSA plurality/mask panel, linear mask tracks, ChimeraX mask-context script, ProteinMPNN diversity plots, linked fold-review visuals, and a manifest-backed marimo notebook. WT Biohub ESMC SAE feature frames, feature-window heatmaps, and feasibility/selection matrices remain planned follow-on surfaces |
