...
| Generation-policy v2 cleanup spec | `../contexts/generation-policy-cleanup-dev-spec.md` |
...
| --- | --- | --- |
| Generic fixed-backbone IA and candidate-review dev spec | `../../../dev/plans/cross-tool/thread/2026-06-19-eco1-rt-repack-thread.md` | materialized selection-readiness spec plus active RT-only candidate-handoff slice: feasibility, three-window SAE summary, candidate triage, global six-row selection, and downstream handoff |
...
| Generation-policy v2 pool | `../contexts/generation-policy-cleanup-dev-spec.md`, `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/generation_policies/`, `../../../../docs/bu-scc/jobs/eco1-proteinmpnn-generation-policy.qsub`, and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/` | active regenerated ProteinMPNN policy pool; three complete generation policies produced 1007 nonredundant candidates, fold-check outputs, fold-review structures, selection-readiness tables, and review links. Variants are complete sequences from one policy, not post hoc mutation compositions |
...
| ProteinMPNN sample ingest | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/proteinmpnn_sample_ingest/`, `../../../../src/dnadesign/thread/adapters/proteinmpnn/`, and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/` | active v2 pool materialized from complete generation-policy runs. Sample rows carry policy provenance and are complete ProteinMPNN sequences, not merged mutation sets |
| Candidate table | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/candidate_table/`, `../../../../src/dnadesign/thread/candidates/`, and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/candidate_table.parquet` | active v2 candidate table with policy provenance, accepted sequence rows, protected-position audit fields, and canonical-position mutation summaries |
| Fold-check request | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/foldcheck_request/`, `../../../../src/dnadesign/thread/foldcheck/`, and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/foldcheck_request/foldcheck_request_manifest.yaml` | active v2 request for full 320-aa canonical sequences generated from policy-provenance candidates |
| Fold validation | `../contexts/fold-validation-policy.md`, `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/foldcheck_report/`, `../../../../src/dnadesign/thread/adapters/colabfold/`, and `../../../../src/dnadesign/thread/foldcheck/` | active v2 ColabFold-normalized report under `generation_policies_v2/`; raw ColabFold outputs remain on SCC or local scratch, compact reports are local |
| Generation-policy v2 fold-check review | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/foldcheck_review/foldcheck_candidate_ranking.parquet` | active v2 fold-review ranking and local structure set for the 1007-candidate policy pool |
| Fold-check review | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/foldcheck_review/` and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/foldcheck_review/` | active v2 fold-review bundle; separates WT-runtime RMSD from direct cryoEM-reference RMSD, stages local PDBs for structure browsing, and records fold metrics used by selection-readiness |
| Review deliverables | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/review_deliverables/` and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/` | materialized review bundle; writes mask/MSA evidence, fold-review links, reference and fold structure browsers, active v2 selected-panel structure browsing, active v2 panel-selection visuals, and a marimo notebook. ESMC LLR, 300M-versus-6B score comparison, SAE feature review, and WT model-check plots remain supporting context rather than panel-selection evidence |
| Interactive browser structure review | `../../../../src/dnadesign/thread/structure_views/` and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/structure_browser/` | materialized interactive inspection for the Ec86 reference and fitted fold models; uses py3Dmol through the generic `dnadesign.thread.structure_views` contract. The constraint-evidence section highlights one selected mask-evidence category at a time on the ec86kit/7V9U reference using a single high-contrast highlight color. The design/fold triage section reuses baseline foldcheck_review PDBs for audit. The panel-selection section uses the active selection root and shows WT plus the selected primary panel with pLDDT, RMSD, mutation count, MSA support, mutation count near retained DNA/RNA or thumb-track positions, charge change, and chemistry warnings beside the viewer. Structure group labels are section-specific, and molecule-visibility controls stay stable while moving between visuals. Raw local PDB files remain unchanged, and the browser view does not replace ColabFold fold validation |
...
| Panel-selection visuals | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/selection/plots/` | active compact SVGs for the primary-panel funnel, local-structure thresholds, selected local RMSD, selected substitutions, regional mutation burden, near retained DNA/RNA chemistry, near-region charge sensitivity, region-wise MSA support, and mutation-set dissimilarity; the review-deliverables notebook links these plus nonvisual evidence/export rows for the selected-panel table, local-structure metric table, threshold-sensitivity table, region-wise MSA support table, selected protein-sequence CSV, and RT-only handoff readiness through the v2 selection manifest |
...
| SAE window summary | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/sae_window_summary/` | model-window review context only; not an acceptance gate or selector |
...
| Selection readiness | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/selection_readiness/` and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/selection/selection_readiness_manifest.yaml` | active v2 feasibility, triage, local-structure region metrics, charge-sensitivity audit, primary-panel trace, and primary conservative panel for the 1007-candidate policy pool; MSA support, mutation geography, local chemistry, local/global fold metrics, and sequence nonredundancy explain panel choices |
| Candidate triage table | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/selection/candidate_triage_table.parquet` | active table joining fold review, feasibility, policy provenance, MSA support, mutation geography, near retained DNA/RNA or thumb-track chemistry, local-structure gate fields, and sequence diversity without reducing them to one combined rank |
| Candidate selection panel | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/selection/candidate_selection_panel.parquet` | active primary panel selected globally after preservation and chemistry/support gates; all six current rows are distal-scaffold policy rows, not an activity ranking and not selected by ESMC or SAE |
| Selected protein sequence export | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/generation_policies_v2/selection/candidate_handoff_sequences.csv` | active flat RT-only protein sequence table for the selected primary panel; it carries sequence hashes and explicit not-materialized DNA-design/restriction-screen status, and it is the sequence authority for later handoff planning |
