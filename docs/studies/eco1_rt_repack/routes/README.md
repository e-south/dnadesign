...
| Fold-check request | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/foldcheck_request/`, `../../../src/dnadesign/thread/foldcheck/`, and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/foldcheck_request/foldcheck_request_manifest.yaml` | materialized locally; one WT baseline plus 96 accepted candidates as full 320-aa canonical sequences, planned for ColabFold `colabfold_batch` CLI execution on BU SCC |
...
| Fold-check review | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/foldcheck_review/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/foldcheck_review/` | materialized locally; ranks 96 candidates, separates WT-runtime RMSD from direct cryoEM-reference RMSD, stages a selected review panel, stages a full local 97-PDB fold set for ChimeraX, writes a ChimeraX-rendered selected-structure overlay when available, and emits an Atlas subset manifest plus alt-text-backed review visuals and a scoped marimo notebook without accepting candidates |
| Review deliverables foundation | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/review_deliverables/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/` | materialized foundation bundle; writes a manifest-relative visual manifest, a Mestre-derived clade 9 scaffold/mask-evidence panel, linear mask tracks, ProteinMPNN diversity plots, a Tao-style ColabFold RMSD/pLDDT joint plot for the current single mask policy, linked fold-review SVG/PNG visuals, linked WT ESMC masked-marginal plots, MSA-vs-ESMC model-constraint audit plots with correlation evidence, exact-dictionary Biohub ESMC SAE interpretation plots, a joint SAE-similarity/ColabFold-pLDDT/ESMC-single-substitution-LLR review panel, and a manifest-backed marimo notebook organized by progressive analysis sections with fitted visual previews and scoped structure dropdowns |
| Interactive browser structure review | `../../../src/dnadesign/thread/structure_views/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/structure_browser/` | materialized review-only surface; uses py3Dmol through the generic `dnadesign.thread.structure_views` contract. The scaffold/mask section highlights one selected mask-evidence category at a time on the ec86kit/7V9U reference using a single high-contrast highlight color. The ColabFold section reuses local foldcheck_review PDBs, fits each selected query to the reference in memory over mapped C-alpha atoms, and shows a compact metric strip for pLDDT, RMSD, sequence identity, and mutation burden. Raw local PDB files remain unchanged, and the browser view does not replace ColabFold fold validation |
| ChimeraX still and pose review | `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/mask_structure_context/` and `.agents/skills/chimerax-structure-review/` | materialized scripts/render where local ChimeraX is available; ChimeraX remains the still-render, manual pose-capture, and publication-image path. Browser-native py3Dmol views are for interactive review only |
| Planned review follow-ons | `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/biohub_esmc_wt_feature_frames/`, `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/biohub_esmc_feature_heatmap/`, and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/selection_and_feasibility/` | planned follow-on surfaces, not part of the materialized foundation bundle |
