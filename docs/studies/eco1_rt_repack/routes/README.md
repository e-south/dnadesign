...
| Design-class expansion | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/design_classes/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/design_class_manifest.yaml` | materialized request surfaces for five added classes: clade 9 p25 contact 6/8/10 A, clade 9 p50 contact 5 A, and II-A3/`42_1` p50 contact 5 A. The current 5 A class remains the baseline. Candidate-pool materialization deduplicates by sequence hash and currently marks all generated classes as pending ProteinMPNN candidate tables |
...
| Expanded candidate pool | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/design_classes/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/candidate_pool_manifest.yaml` | materialized as a nonredundant sequence-hash pool. It currently contains only the 96 existing baseline candidates and records the five generated classes as pending until their ProteinMPNN runs and per-class candidate tables are present |
