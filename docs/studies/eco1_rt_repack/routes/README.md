...
| Review-notebook follow-on | `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/review_deliverables/selection_and_feasibility/` | feasibility, triage, and selected-panel tables exist under `design_classes/selection/`; compact selection-readiness visuals and a first-class notebook lane are still follow-on work |
...
| Selection readiness | `../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/selection_readiness/` and `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/selection_readiness_manifest.yaml` | materialized feasibility, triage, and six-row one-per-design-class panel for the expanded candidate pool; SAE windows are recorded but not used for selection |
| Candidate triage table | `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/candidate_triage_table.parquet` | materialized table joining fold review, feasibility, SAE-window fields, sequence diversity, and ESMC additive LLR fields without reducing them to one combined rank |
| Candidate selection panel | `../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/candidate_selection_panel.parquet` | materialized six-row panel with one feasible fold-preserved representative per design class; not a top-six score ranking |
