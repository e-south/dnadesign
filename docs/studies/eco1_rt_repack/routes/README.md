...
| Panel-selection visuals | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/plots/` | materialized compact SVGs for design-class gate counts and mask-policy contrasts, local-structure thresholds, selected local RMSD, class-local percentiles, premise alignment, selected substitutions, regional mutation burden, near-DNA/RNA chemistry, region-wise MSA support, and sequence distance; the review-deliverables notebook links these plus nonvisual evidence/export rows for the selected-panel table, local-structure metric table, threshold-sensitivity table, region-wise MSA support table, selected protein-sequence CSV, and RT-only handoff readiness through the selection manifest |
...
| Selection readiness | `../../../../src/dnadesign/studies/units/eco1_rt_repack/operations/materialization/selection_readiness/` and `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/selection_readiness_manifest.yaml` | materialized feasibility, triage, local-structure region metrics, and six-row one-per-design-class panel for the expanded candidate pool; MSA support, mutation geography, local chemistry, local/global fold metrics, and sequence nonredundancy explain panel choices |
| Candidate triage table | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/candidate_triage_table.parquet` | materialized table joining fold review, feasibility, MSA support, mutation geography, near-DNA/RNA or thumb-track chemistry, local-structure gate fields, sequence diversity, SAE-window fields, and ESMC additive LLR fields without reducing them to one combined rank |
| Candidate selection panel | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/candidate_selection_panel.parquet` | materialized six-row panel with one feasible fold-preserved representative per design class after local-structure metrics are available and pass local RMSD thresholds; not a top-six score ranking and not selected by ESMC or SAE |
