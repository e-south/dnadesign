...
| Candidate selection panel | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/candidate_selection_panel.parquet` | materialized primary panel selected globally from stricter primary-panel candidates after local-structure, C-terminal/thumb, near retained DNA/RNA chemistry, and proximal MSA-support checks; not an activity ranking and not selected by ESMC or SAE |
