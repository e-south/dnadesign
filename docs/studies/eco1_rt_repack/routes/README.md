...
| Panel-selection visuals | `../../../../src/dnadesign/studies/units/eco1_rt_repack/workspaces/eco1_rt_conservative_v1/outputs/thread/design_classes/selection/plots/` | materialized compact SVGs for gate counts by design class, selected-panel review axes, selected sequence differences, and selected mutation chemistry/geography; the review-deliverables notebook links these, the selected-panel table, and the RT-only handoff boundary through the selection manifest |
