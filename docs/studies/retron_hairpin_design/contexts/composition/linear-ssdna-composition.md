...
| How is a lab-facing MSD shorthand label normalized and linted? | Retron study `compiler/catalog/msd_design_registry.yaml` plus `dnadesign.studies.studies.retron_hairpin_design.cli` |
