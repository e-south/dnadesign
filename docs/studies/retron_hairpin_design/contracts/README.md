## Retron Study Contracts

**Owner:** dnadesign-maintainers
**Last verified:** 2026-05-18

This directory holds Ops-facing contracts for the Retron hairpin design study.
The root study record stays the entrypoint; these files define observation and
readiness surfaces.
