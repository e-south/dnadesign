## junction Boundary Proposal

**Status:** superseded by
[ADR 0003](../../../architecture/decisions/adr-0003-junction-peer-tool.md)
**Date:** 2026-08-01
...
- The peer-reviewed paper requires actual `t/t*` and `b/b*` complementarity,
  ...
  product recovery. junction names those oligos complement strands because
...
- The preprint's later Type IIS/Golden Gate step is downstream processing, so a
  ...
  making junction responsible for enzyme or overhang handling.
...
public PR review. ADR 0003 accepts `dnadesign.junction` as a peer tool and
records the stable ownership, assembly-group, molecular, recovery, security,
