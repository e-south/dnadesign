...
| `latentdna` | [LatentDNA Docs](../../src/dnadesign/latentdna/docs/README.md) | Comparison workflows, workspace contracts, and read-only QC surfaces for promoter studies. |
