...
| `usr.data-plane.permuter-construct-infer-handoff` | [Permuter -> Construct -> Infer Shared Dataset Runbook](../../src/dnadesign/usr/docs/operations/assembly/permuter-construct-infer-shared-dataset.md) | `runbook` | `data-plane` | `staged` | `usr-dataset-state` | Route Permuter-originated variants through study-owned promotion, Construct context realization, and Infer-owned sidecars without coupling tool internals. |
